...
class StoreUnitRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'category' => 'nullable|in:land,property',
            'ownership' => 'nullable|array',
            'ownership.contract_type' => 'nullable|string|max:255',
            'ownership.is_registered' => 'nullable|boolean',
            'ownership.plot_number' => 'nullable|string|max:255',
