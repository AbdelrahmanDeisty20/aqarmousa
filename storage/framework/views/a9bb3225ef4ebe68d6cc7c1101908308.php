...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.dropdown.index','data' => ['teleport' => $shouldTeleport,'placement' => $placement,'width' => $isFlagsOnly ? 'w-fit fls-flag-only-width' : 'w-fit fls-dropdown-width','maxHeight' => $maxHeight,'class' => 'fi-dropdown fi-user-menu','dataNosnippet' => 'true']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['teleport' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($shouldTeleport),'placement' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($placement),'width' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($isFlagsOnly ? 'w-fit fls-flag-only-width' : 'w-fit fls-dropdown-width'),'max-height' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($maxHeight),'class' => 'fi-dropdown fi-user-menu','data-nosnippet' => 'true']); ?>
...
<?php $component->withAttributes(['class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\Illuminate\Support\Arr::toCssClasses(['!border-t-0 space-y-1 !p-2.5']))]); ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $locales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php /**PATH C:\myProjects\aqarmousa\vendor\bezhansalleh\filament-language-switch\resources\views/switch.blade.php ENDPATH**/ ?>